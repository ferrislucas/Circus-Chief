<template>
  <div class="summary-content card">
    ...
    <div class="summary-footer">
      ...
      <button class="btn-link" @click="$emit('regenerate')" :disabled="generatingManual">
...
defineProps({
  ...
  generatingManual: { type: Boolean, default: false },
  hasPrInfo: { type: Boolean, default: false },
  prUrl: { type: String, default: null },
  formatOutcome: { type: Function, required: true },
  formatPrState: { type: Function, required: true },
  extractPrNumber: { type: Function, required: true },
