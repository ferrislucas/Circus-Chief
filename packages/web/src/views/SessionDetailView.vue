...
.tab-content { min-height: 400px; padding-bottom: 1.5rem; }
...
@media (max-width: 640px) {
  .session-detail { padding-right: 0; padding-left: 0; }
  .session-detail :deep(.session-header), .session-detail :deep(.tabs) { padding-right: var(--page-gutter); padding-left: var(--page-gutter); }
}
</style>
