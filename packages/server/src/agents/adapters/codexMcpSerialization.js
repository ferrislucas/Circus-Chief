...
/**
 * Codex MCP `-c` CLI argument serialization.
 *
 * Split out of CodexAdapter.js to keep the adapter's execution paths readable;
 * everything here is pure argument/env shaping with no I/O.
 */
