...
import { sessions, messages, sessionNotes, projects, todos, workLogs, conversations } from '../database.js';
...
router.get('/:id/messages', (req, res) => {
  ...
  if (conversation_id) {
    ...
    const convMessages = messages.getByConversationId(conversation_id);
    ...
    if (activeConv) {
      const convMessages = messages.getByConversationId(activeConv.id);
      res.json(convMessages);
    } else {
