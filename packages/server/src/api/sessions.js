...
// Returns: {staged, unstaged, untracked} diffs
// Note: Query parameters (compareMode, branch) are ignored for backwards compatibility
router.get('/:id/changes', async (req, res) => {
  ...
  try {
    ...
    // Query parameters are ignored for backwards compatibility
